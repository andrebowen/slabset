...
def field_view(shape):
    return (
        ...
        '<span class="out-sub-line">Order <b data-premix>0.0</b> m³ ready-mix, or <b data-bags>0</b> individual 20 kg bags</span></div></div></div>'
        '</section>'
...
def spec_view(page):
    ...
    return (
        ...
        '<p class="sp-order-line">Order <b data-premix>0.0</b> m³ ready-mix, or <b data-bags>0</b> individual 20 kg bags</p></section>'
